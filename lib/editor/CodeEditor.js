...
var CodeEditor = function (_Component) {
  ...
  _createClass(CodeEditor, [{
    ...
    value: function componentDidUpdate(prevProps) {
      var valueChanged = this.props.value !== this.mirror.getValue();
      var propsChanged = prevProps.value !== this.props.value;
    ...
    value: function componentDidMount() {
      ...
      this.mirror.on('change', function (editor) {
        var newValue = editor.getValue();
        if (newValue === _this2.props.value) return;

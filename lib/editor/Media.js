    ...
    value: function render() {
      ...
      if (type === 'PHOTO') return _react2.default.createElement(
        MediaEditor,
        {
          ...
          onChange: this.props.onChange },
        _react2.default.createElement('img', { className: '', alt: data.src, src: data.src })
      );
...
function Toolbar(_ref2) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'pa2 bg-black-30 white absolute w-100 tl' },
    children
  );
}
...
var MediaEditor = function (_Component2) {
  ...
  function MediaEditor() {
    ...
    return _ret2 = (_temp2 = (_this2 = _possibleConstructorReturn(this, (_ref3 = MediaEditor.__proto__ || Object.getPrototypeOf(MediaEditor)).call.apply(_ref3, [this].concat(args))), _this2), _this2.handleKeyPress = function (e) {
      if (e.key === 'Enter') {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          upload && _react2.default.createElement(
            ...
            data.progress && data.src === LOADING_IMAGE && _react2.default.createElement(
              'span',
              null,
              data.progress,
              ' %'

...
var RichEditor = function (_Component) {
  ...
  function RichEditor(props) {
    ...
    _this.addPhoto = function () {
      _this.addMedia('PHOTO', { src: _Media.DEFAULT_IMAGE })();
    };

    _this.addYoutube = function () {
      _this.addMedia('YOUTUBE', { src: 'https://www.youtube.com/embed/dQw4w9WgXcQ' })();
    };

    _this.addInstagram = function () {
      _this.addMedia('INSTAGRAM', { src: 'https://www.instagram.com/p/BMWm4GPjxEV' })();
    };
    ...
    _this.addHTML = function () {
      _this.addMedia('HTML', { content: '<b>Hello</b> hello' })();
    };

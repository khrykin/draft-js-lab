...
var _fetchWithProgress = require('./fetchWithProgress');

var _fetchWithProgress2 = _interopRequireDefault(_fetchWithProgress);
...
var RichEditor = function (_Component) {
  ...
  function RichEditor(props) {
    ...
    _this.uploadImageForKey = function (entityKey, files) {
      ...
      (0, _fetchWithProgress2.default)(_this.props.uploadURL, {
        headers: {
        ...
        if (e.lengthComputable) {
          ...
          _this.replaceEntityData(entityKey, {
            src: '',
            filename: file.name,
            size: file.size,
            progress: percentage
        ...
        return _this.replaceEntityData(entityKey, {
          src: res.file.normal,
          filename: file.name,
          size: file.size,
          uploaded: true
    ...
    _this.uploadAttachmentForKey = function (entityKey, files) {
      ...
      (0, _fetchWithProgress2.default)('/api/documents/upload', {
        headers: {
          'Accept': 'application/json'
        },
        method: "POST",
